            ...
            <div class="container-fluid animated fadeIn">
                ...
                <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-check-square-o fa-lg m-t-2"></i>未填报的活动
                                </div>
                                <div class="card-block">

                        <table class="table table-bordered table-striped table-condensed">
                            <tbody>
                                <?php if(is_array($actives)): $i = 0; $__LIST__ = $actives;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
