...
<head>
    ...
    <meta name="description" content="已填报的活动">
            ...
            <div class="container-fluid animated fadeIn">
                ...
                <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-check-square fa-lg m-t-2"></i> 我已填报的活动
                                </div>
                                <div class="card-block">
<!--                       <table class="table">

                                        <tbody>
                                            <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li style="list-style-type:none;"><a href="<?php echo (SITE_URL_L); ?>home/index/detailed/id/<?php echo ($vo["id"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a><span><?php echo ($vo["time"]); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>                            
                                        </tbody>
                                    </table>   --> 
                        <table class="table table-bordered table-striped table-condensed">
                            <tbody>
                                <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        <td><a href="<?php echo (SITE_URL_L); ?>home/index/detailed/id/<?php echo ($vo["id"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a></td>
                                        <td style="text-align: center;"><?php echo ($vo["editor"]); ?></td>
