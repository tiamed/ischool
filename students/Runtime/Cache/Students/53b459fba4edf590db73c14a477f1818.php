...
<!--                             <li class="nav-item">
        ...
        <main class="main">
            <div class="container-fluid animated fadeIn">
                <div class="card">
                    ...
                    <i class="fa fa-align-justify"></i>填写问卷调查
                    </div>
                    <div class="card-block">
                        <div class="form-horizontal col-md-9">
                            <div class="insert_poll" >
                            </div>
                            <script type="text/template" id="poll">
                                {{#survey}}
                                <div class="form-group">
                                    <label class="form-form-control-label">{{count}}. {{title}}</label>
                                    {{#radio}}
                                        <div class="radio" style="margin-left: 1.2rem">
                                            <label for="{{value}}">
                                                <input type="radio" name="{{id}}" value="{{value}}">{{value}}
                                            </label>
                                        </div>
                                    {{/radio}}
                                    {{#checkbox}}
                                        <div class="checkbox" style="margin-left: 1.2rem">
                                            <label for="{{value}}">
                                    ...
                                    {{/checkbox}}
                                    {{#text}}
                                        <input type="text" class="form-control" id="{{id}}" style="margin-left: 1.2rem">
                                    {{/text}}
                                </div>
                                {{/survey}}
                            </script>
                    ...
                    <div class="card-footer">
                        <div class="custom-button">
                            <button type="submit" class="btn btn-success" onclick="posta()" style="margin-left: 0.8rem;">
                                <i class="fa fa-dot-circle-o">
                                </i>
                                提交
                            </button>
                            &nbsp;&nbsp;&nbsp;
                            <button type="reset" class="btn btn-danger" onclick="return reload();">
                                <i class="fa fa-ban">
                                </i>
                                重置
                            </button>
    ...
    <script src="<?php echo (ADMIN_JS_URL); ?>mustache.js" type="text/javascript"></script>

    <script src="<?php echo (HOME_JS_URL); ?>poll.js"</script>
    ...
    <script type="text/javascript">
        ...
        var path = "<?php echo (HOME_JS_URL); ?>poll.json";
        var xpath = "<?php echo (SITE_URL_L); ?>students/Index/poll/id/<?php echo ($id); ?>";
        var repath = "<?php echo (SITE_URL_L); ?>students/Index/infolisted";
        $(document).ready(json());
    </script>
</body>
